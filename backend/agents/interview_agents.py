...
def question_generator_agent(state: dict) -> dict:
    """Generates interview questions with rubric from JD + CV analyses.
    
    Reads from state: jd_analysis, cv_analysis, categories, existing_questions
    ...
    raw = _call_openai(QUESTION_GEN_SYSTEM, user_prompt, max_tokens=4000)
...
def regenerate_single_question(jd_doc_id: str, cv_doc_id: str, old_question: str, category: str, difficulty: str) -> dict:
